...
export async function generateMetadata({
  ...
  let ogImage = image
    ? `https://thiru.site${image}`
    : `https://thiru.site/og?title=${title}`;
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      publishedTime,
      url: `https://thiru.site/blog/${post.slug}`,
      images: [
        {
          url: ogImage,
        },
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image: post.metadata.image
              ? `https://thiru.site${post.metadata.image}`
              : `https://thiru.site/og?title=${post.metadata.title}`,
            url: `https://thiru.site/blog/${post.slug}`,
            author: {
              "@type": "Person",
              name: "Lee Robinson",
